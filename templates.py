def acc_verification(link, name):
    template = '''
	<!DOCTYPE html>
				...
				<tr>
					<td>
						...
						<table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-3"
							role="presentation"
							style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #F4F4F4; background-image: url('images/bg_wave_1.png'); background-position: top center; background-repeat: repeat;"
							width="100%">
							<tbody>
								<tr>
									<td>
											...
											<tbody>
												<tr>
													<td class="column column-1"
														...
														width="100%">
														<div class="spacer_block"
															style="height:90px;line-height:90px;font-size:1px;"> </div>
													</td>
												</tr>
											</tbody>
										</table>
						...
						<table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-4"
							role="presentation"
							style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #F4F4F4;" width="100%">
							<tbody>
								<tr>
									<td>
										<table align="center" border="0" cellpadding="0" cellspacing="0"
																	...
																	<div
																		...
																		<div class=""
																			...
																			<p
																				...
																				<strong><span
																						style="font-size:30px;">Welcome,
																						<span
																							style="color:#41B281;font-size:30px;">{rec_name}</span>!</span></strong>
																			</p>
																		</div>
																	</div>
																</td>
															...
															<tr>
																<td class="pad"
																	...
																	<div style="font-family: sans-serif">
																		<div class=""
																			style="font-size: 12px; mso-line-height-alt: 18px; color: #7C7C7C; line-height: 1.5; font-family: Open Sans, Helvetica Neue, Helvetica, Arial, sans-serif;">
																			<p style="margin: 0; font-size: 12px; mso-line-height-alt: 24px;">
																				<span style="font-size:16px;">The SAS Team is very glad
																				...
																				<b>Due to security reasons, the link is only usable within one hour.</b>
																			</p>
																		</div>
																	</div>
																	<div style="margin-top: 20px;">
																		<a href="{ver_link}" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#41B281;border-radius:5px;width:auto;border-top:0px solid transparent;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:10px;padding-bottom:10px;font-family:Open Sans, Helvetica Neue, Helvetica, Arial, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"
																			target="_blank"><span style="padding-left:20px;padding-right:20px;font-size:18px;display:inline-block;letter-spacing:1px;"><span
																			dir="ltr" style="word-break: break-word;"><span data-mce-style="" dir="ltr"><strong>
																			Verify
	...
	'''.format(rec_name=name, ver_link=link)
    return template
